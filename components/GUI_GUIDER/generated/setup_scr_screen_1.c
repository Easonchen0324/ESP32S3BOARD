...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_1, 240, 300);
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 135, 39);
    lv_obj_set_size(ui->screen_1_btn_1, 81, 43);
    ui->screen_1_btn_1_label = lv_label_create(ui->screen_1_btn_1);
    lv_label_set_text(ui->screen_1_btn_1_label, "AP Pair");
    ...
    lv_obj_set_pos(ui->screen_1_btn_2, 23, 39);
    lv_obj_set_size(ui->screen_1_btn_2, 78, 40);
    ui->screen_1_btn_2_label = lv_label_create(ui->screen_1_btn_2);
    lv_label_set_text(ui->screen_1_btn_2_label, "Ble Pair");
    ...
    lv_obj_set_style_bg_color(ui->screen_1_btn_2, lv_color_hex(0x00ff47), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    // 界面 1：SmartConfig 配网按钮
    ui->screen_1_btn_3 = lv_button_create(ui->screen_1);
    lv_obj_set_pos(ui->screen_1_btn_3, 43, 111);
    lv_obj_set_size(ui->screen_1_btn_3, 152, 42);
    ui->screen_1_btn_3_label = lv_label_create(ui->screen_1_btn_3);
    lv_label_set_text(ui->screen_1_btn_3_label, "Smart config");
    ...
    lv_obj_set_style_bg_color(ui->screen_1_btn_3, lv_color_hex(0x2FDAAE), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    // 界面 1：Wi-Fi OTA 网页服务按钮
    ui->screen_1_btn_4 = lv_button_create(ui->screen_1);
    lv_obj_set_pos(ui->screen_1_btn_4, 23, 179);
    lv_obj_set_size(ui->screen_1_btn_4, 78, 40);
    ui->screen_1_btn_4_label = lv_label_create(ui->screen_1_btn_4);
    lv_label_set_text(ui->screen_1_btn_4_label, "Ota");
    ...
    lv_obj_set_style_bg_color(ui->screen_1_btn_4, lv_color_hex(0x861078), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    // 界面 1：返回主界面按钮
    ui->screen_1_btn_5 = lv_button_create(ui->screen_1);
    lv_obj_set_pos(ui->screen_1_btn_5, 135, 179);
    lv_obj_set_size(ui->screen_1_btn_5, 78, 40);
    ui->screen_1_btn_5_label = lv_label_create(ui->screen_1_btn_5);
    lv_label_set_text(ui->screen_1_btn_5_label, "Back");
    ...
    lv_obj_set_style_bg_color(ui->screen_1_btn_5, lv_color_hex(0x938810), LV_PART_MAIN|LV_STATE_DEFAULT);
